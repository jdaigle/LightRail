 ...
 * https://github.com/Particular/NServiceBus/blob/2.0/src/utils/MsmqUtilities.cs
 * 
...
namespace LightRail.Msmq
{
    ...
    {
        private static readonly ILogger Logger = LogManager.GetLogger(typeof(MsmqUtilities));
