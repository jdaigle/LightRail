...
namespace LightRail
{
    ...
    {
        private static readonly ILogger logger = LogManager.GetLogger("LightRail.PipelinedBehavior");
        ...
        private static readonly Action<MessageContext> EmptyAction = new Action<MessageContext>(m => { });
        ...
        public static Action<MessageContext> CompileMessageHandlerPipeline(IEnumerable<PipelinedBehavior> behaviors)
        {
            ...
            return new Action<MessageContext>(m => behavior.Invoke(m, CompileMessageHandlerPipeline(behaviors.Skip(1))));
        }
    }
}
